...
FUNCTION('ST_GeomFromText', ...): Converts the input point in WKT format (POINT(lon lat)) into a geometry object compatible with MySQL's spatial functions.
Dynamic Parameters:
:point should be passed as POINT(lon lat) in WKT format, e.g., POINT(18.0632 59.3346).
